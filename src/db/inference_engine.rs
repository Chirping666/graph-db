...
use crate::types::{EdgeId, NodeId, PropertyKeyId, TypeId};
...
mod tests {
    use super::*;
    use crate::inference::{InferenceResult, InferredEntity, InferredFact, ProvenanceRecord};
    use crate::types::{EdgeId, NodeId, PropertyKeyId, TypeId};
    ...
    impl InferenceRule for DummyRule {
        ...
        fn infer(
            &self,
            _graph: &dyn crate::schema::GraphView,
            _types: &dyn crate::schema::TypeRegistryView,
            _keys: &dyn crate::schema::PropertyKeyRegistryView,
        ) -> InferenceResult {
            InferenceResult {
                facts: vec![],
