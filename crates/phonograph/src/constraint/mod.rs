...
///
/// ```
/// use phonograph::constraint::NodeChange;
/// use phonograph::types::{Node, NodeId};
...
///
/// ```
/// use phonograph::constraint::EdgeChange;
/// use phonograph::types::{Edge, EdgeId, NodeId};
/// use std::collections::BTreeMap;
///
/// let edge = Edge {
///     id: EdgeId(1),
...
///
/// ```
/// use phonograph::constraint::{ConstraintViolation, ViolationSubject};
...
///
/// ```
/// use phonograph::constraint::ViolationSubject;
/// use phonograph::NodeId;
///
