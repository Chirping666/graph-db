...
pub trait ReadAt: BackendErrorType {
...
///
/// This trait is object-safe.
pub trait WriteAt: BackendErrorType {
...
///
/// This trait is object-safe.
pub trait Durability: BackendErrorType {
...
mod tests {
    use super::*;
    use super::super::error::{BackendError, StorageErrorKind};
    use alloc::vec::Vec;
    ...
    impl BackendErrorType for MockBackend {
